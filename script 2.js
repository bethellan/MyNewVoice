...
const OFFLINE_CACHE_NAME = 'mynewvoice-offline-v94';
...
function showSettingsEntryOverlay() {
    ...
    const infoButton = overlay.querySelector('[data-settings-entry-information]');
    if (infoButton) infoButton.focus({ preventScroll: true });
}
...
function closeAboutToSettingsEntry() {
    ...
    if (entryOverlay) {
        ...
        const infoButton = entryOverlay.querySelector('[data-settings-entry-information]');
        if (infoButton) infoButton.focus({ preventScroll: true });
    }
}
        ...
        <div class="settings-panel">
            ...
            <div class="settings-dashboard settings-task-dashboard settings-commercial-dashboard" aria-label="Settings dashboard">
                ...
                <section class="settings-group settings-group-wide settings-section-card settings-section-content">
                    ...
                    <p class="settings-group-note">Edit menus, phrases, pictures, fallback icons and recorded voices.</p>
                    <div class="settings-actions settings-actions-compact">
                        <button type="button" class="settings-action-btn settings-action-prominent" data-open-management><span class="settings-card-icon" aria-hidden="true">✎</span><span class="settings-card-text"><strong>Edit Content</strong><small>Menus, phrases, photos, voices.</small></span></button>
                    </div>
                </section>
...
function renderContentTopicsScreen(panel, allCategories) {
    panel.innerHTML = `
        ...
        <div class="private-setup-footer editor-bottom-actions settings-standard-actionbar compact-save-actions">
            <button type="button" class="management-btn close-btn" data-content-back-settings>Cancel</button>
            <button type="button" class="management-btn save-private-setup" data-content-save-close>Save</button>
        </div>
    `;
}
...
function renderContentPhraseScreen(panel, category) {
    ...
    panel.innerHTML = `
        ...
        <div class="private-setup-footer editor-bottom-actions settings-standard-actionbar compact-save-actions">
            <button type="button" class="management-btn close-btn" data-content-back-topics>Cancel</button>
            <button type="button" class="management-btn save-private-setup" data-content-save-close>Save</button>
        </div>
    `;
}
